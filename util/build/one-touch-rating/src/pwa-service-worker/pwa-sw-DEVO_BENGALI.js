(function() {
	...
	var hostName = "https://bengali-devo.ptlp.co";
	var apiPrefix = "https://bengali-devo.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_BENGALI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_BENGALI.json" ) === -1
