(function() {
	...
	var hostName = "https://tamil-devo.ptlp.co";
	var apiPrefix = "https://tamil-devo.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_TAMIL.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_TAMIL.json" ) === -1
