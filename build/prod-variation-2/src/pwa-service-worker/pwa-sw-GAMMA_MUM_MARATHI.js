(function() {
	...
	var hostName = "https://marathi-mum-gamma.pratilipi.com";
	var apiPrefix = "https://marathi-mum-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MUM_MARATHI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MUM_MARATHI.json" ) === -1
