(function() {
	...
	var hostName = "https://telugu-gamma-gr.pratilipi.com";
	var apiPrefix = "https://telugu-gamma-gr.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_TELUGU_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_TELUGU_GR.json" ) === -1
