(function() {
	...
	var hostName = "https://kannada.pratilipi.com";
	var apiPrefix = "https://kannada.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-KANNADA.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-KANNADA.json" ) === -1
