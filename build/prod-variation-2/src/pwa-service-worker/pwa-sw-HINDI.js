(function() {
	...
	var hostName = "https://hindi.pratilipi.com";
	var apiPrefix = "https://hindi.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-HINDI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-HINDI.json" ) === -1
