(function() {
	...
	var hostName = "https://marathi-gamma.pratilipi.com";
	var apiPrefix = "https://marathi-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MARATHI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MARATHI.json" ) === -1
