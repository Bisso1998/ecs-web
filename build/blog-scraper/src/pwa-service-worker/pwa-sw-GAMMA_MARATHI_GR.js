(function() {
	...
	var hostName = "https://marathi-gamma-gr.pratilipi.com";
	var apiPrefix = "https://marathi-gamma-gr.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MARATHI_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MARATHI_GR.json" ) === -1
