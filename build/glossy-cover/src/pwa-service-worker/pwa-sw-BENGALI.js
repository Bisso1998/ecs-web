(function() {
	...
	var hostName = "https://bengali.pratilipi.com";
	var apiPrefix = "https://bengali.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-BENGALI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-BENGALI.json" ) === -1
