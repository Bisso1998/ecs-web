(function() {
	...
	var hostName = "https://kannada-gamma-gr.pratilipi.com";
	var apiPrefix = "https://kannada-gamma-gr.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_KANNADA_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_KANNADA_GR.json" ) === -1
