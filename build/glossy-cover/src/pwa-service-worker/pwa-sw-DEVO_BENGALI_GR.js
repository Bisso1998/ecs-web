(function() {
	...
	var hostName = "https://bengali-devo-gr.ptlp.co";
	var apiPrefix = "https://bengali-devo-gr.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_BENGALI_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_BENGALI_GR.json" ) === -1
