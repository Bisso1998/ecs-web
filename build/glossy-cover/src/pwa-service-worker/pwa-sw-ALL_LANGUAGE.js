(function() {
	...
	var hostName = "https://www.pratilipi.com";
	var apiPrefix = "https://www.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-ALL_LANGUAGE.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-ALL_LANGUAGE.json" ) === -1
