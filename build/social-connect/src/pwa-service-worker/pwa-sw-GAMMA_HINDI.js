(function() {
	...
	var hostName = "https://hindi-gamma.pratilipi.com";
	var apiPrefix = "https://hindi-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_HINDI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_HINDI.json" ) === -1
