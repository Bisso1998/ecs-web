(function() {
	...
	var hostName = "https://hindi-devo.ptlp.co";
	var apiPrefix = "https://hindi-devo.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_HINDI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_HINDI.json" ) === -1
