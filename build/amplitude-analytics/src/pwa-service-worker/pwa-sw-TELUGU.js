(function() {
	...
	var hostName = "https://telugu.pratilipi.com";
	var apiPrefix = "https://telugu.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-TELUGU.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-TELUGU.json" ) === -1
