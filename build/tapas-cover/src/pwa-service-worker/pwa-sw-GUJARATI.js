(function() {
	...
	var hostName = "https://gujarati.pratilipi.com";
	var apiPrefix = "https://gujarati.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GUJARATI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GUJARATI.json" ) === -1
