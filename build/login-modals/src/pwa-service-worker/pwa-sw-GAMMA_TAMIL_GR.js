(function() {
	...
	var hostName = "https://tamil-gamma-gr.pratilipi.com";
	var apiPrefix = "https://tamil-gamma-gr.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_TAMIL_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_TAMIL_GR.json" ) === -1
