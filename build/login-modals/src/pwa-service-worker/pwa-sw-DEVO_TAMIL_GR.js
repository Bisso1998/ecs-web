(function() {
	...
	var hostName = "https://tamil-devo-gr.ptlp.co";
	var apiPrefix = "https://tamil-devo-gr.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_TAMIL_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_TAMIL_GR.json" ) === -1
