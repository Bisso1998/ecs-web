(function() {
	...
	var hostName = "https://tamil-gamma.pratilipi.com";
	var apiPrefix = "https://tamil-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_TAMIL.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_TAMIL.json" ) === -1
