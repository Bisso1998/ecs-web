(function() {
	...
	var localFilesToCache = [
		'.',
		'pwa-stylesheets/css/style.css?091120171947',
		'pwa-images/404.svg',
	...
	var STATIC_VERSION = "091120171947";
	...
	var hostName = "https://malayalam-gamma-gr.pratilipi.com";
	var apiPrefix = "https://malayalam-gamma-gr.pratilipi.com";

	/* Cache Keys */
	var PWA_INDEX_HTML = "app-shell-091120171947.html";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MALAYALAM_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MALAYALAM_GR.json" ) === -1
