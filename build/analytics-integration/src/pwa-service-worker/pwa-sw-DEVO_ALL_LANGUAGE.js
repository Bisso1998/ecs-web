(function() {
	...
	var hostName = "https://www-devo.ptlp.co";
	var apiPrefix = "https://www-devo.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_ALL_LANGUAGE.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_ALL_LANGUAGE.json" ) === -1
