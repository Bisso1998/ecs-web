(function() {
	...
	var hostName = "https://marathi-devo-gr.ptlp.co";
	var apiPrefix = "https://marathi-devo-gr.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_MARATHI_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_MARATHI_GR.json" ) === -1
