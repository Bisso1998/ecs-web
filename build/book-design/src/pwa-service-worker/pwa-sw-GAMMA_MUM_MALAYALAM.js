(function() {
	...
	var localFilesToCache = [
		'.',
		'pwa-stylesheets/css/style.css?060320181355',
		'pwa-images/404.svg',
	...
	var STATIC_VERSION = "060320181355";
	...
	var hostName = "https://malayalam-mum-gamma.pratilipi.com";
	var apiPrefix = "https://malayalam-mum-gamma.pratilipi.com";

	/* Cache Keys */
	var PWA_INDEX_HTML = "app-shell-060320181355.html";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MUM_MALAYALAM.js" ) === -1
			...
			&& url.indexOf( hostName + "/elements.ml" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MUM_MALAYALAM.json" ) === -1
