(function() {
	...
	var hostName = "https://hindi-mum-gamma.pratilipi.com";
	var apiPrefix = "https://hindi-mum-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MUM_HINDI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MUM_HINDI.json" ) === -1
