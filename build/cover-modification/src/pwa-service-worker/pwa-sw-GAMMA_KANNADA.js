(function() {
	...
	var hostName = "https://kannada-gamma.pratilipi.com";
	var apiPrefix = "https://kannada-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_KANNADA.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_KANNADA.json" ) === -1
