(function() {
	...
	var hostName = "https://gujarati-devo-gr.ptlp.co";
	var apiPrefix = "https://gujarati-devo-gr.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_GUJARATI_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_GUJARATI_GR.json" ) === -1
