(function() {
	...
	var hostName = "https://kannada-devo.ptlp.co";
	var apiPrefix = "https://kannada-devo.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_KANNADA.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_KANNADA.json" ) === -1
