(function() {
	...
	var hostName = "https://kannada-devo-gr.ptlp.co";
	var apiPrefix = "https://kannada-devo-gr.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_KANNADA_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_KANNADA_GR.json" ) === -1
