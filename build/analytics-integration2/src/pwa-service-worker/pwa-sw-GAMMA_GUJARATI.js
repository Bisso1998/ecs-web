(function() {
	...
	var hostName = "https://gujarati-gamma.pratilipi.com";
	var apiPrefix = "https://gujarati-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_GUJARATI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_GUJARATI.json" ) === -1
