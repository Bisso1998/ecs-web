(function() {
	...
	var hostName = "https://www-devo-gr.ptlp.co";
	var apiPrefix = "https://www-devo-gr.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_ALL_LANGUAGE_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_ALL_LANGUAGE_GR.json" ) === -1
