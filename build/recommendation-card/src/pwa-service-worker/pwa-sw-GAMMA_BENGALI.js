(function() {
	...
	var hostName = "https://bengali-gamma.pratilipi.com";
	var apiPrefix = "https://bengali-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_BENGALI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_BENGALI.json" ) === -1
