(function() {
	...
	var hostName = "https://gujarati-mum-gamma.pratilipi.com";
	var apiPrefix = "https://gujarati-mum-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MUM_GUJARATI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MUM_GUJARATI.json" ) === -1
