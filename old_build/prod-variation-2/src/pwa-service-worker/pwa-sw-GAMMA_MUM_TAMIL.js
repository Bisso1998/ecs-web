(function() {
	...
	var hostName = "https://tamil-mum-gamma.pratilipi.com";
	var apiPrefix = "https://tamil-mum-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MUM_TAMIL.js" ) === -1
			...
			&& url.indexOf( hostName + "/elements.ta" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MUM_TAMIL.json" ) === -1
