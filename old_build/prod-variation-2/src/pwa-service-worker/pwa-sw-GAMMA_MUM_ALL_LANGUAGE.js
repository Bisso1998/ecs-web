(function() {
	...
	var hostName = "https://www-mum-gamma.pratilipi.com";
	var apiPrefix = "https://www-mum-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MUM_ALL_LANGUAGE.js" ) === -1
			...
			&& url.indexOf( hostName + "/elements.en" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MUM_ALL_LANGUAGE.json" ) === -1
