(function() {
	...
	var hostName = "https://telugu-mum-gamma.pratilipi.com";
	var apiPrefix = "https://telugu-mum-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MUM_TELUGU.js" ) === -1
			...
			&& url.indexOf( hostName + "/elements.te" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MUM_TELUGU.json" ) === -1
