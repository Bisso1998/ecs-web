(function() {
	...
	var hostName = "https://malayalam-devo.ptlp.co";
	var apiPrefix = "https://malayalam-devo.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_MALAYALAM.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_MALAYALAM.json" ) === -1
