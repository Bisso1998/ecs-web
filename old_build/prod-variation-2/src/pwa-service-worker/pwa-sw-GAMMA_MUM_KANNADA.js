(function() {
	...
	var hostName = "https://kannada-mum-gamma.pratilipi.com";
	var apiPrefix = "https://kannada-mum-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MUM_KANNADA.js" ) === -1
			...
			&& url.indexOf( hostName + "/elements.kn" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MUM_KANNADA.json" ) === -1
