(function() {
	...
	var hostName = "https://gujarati-devo.ptlp.co";
	var apiPrefix = "https://gujarati-devo.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_GUJARATI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_GUJARATI.json" ) === -1
