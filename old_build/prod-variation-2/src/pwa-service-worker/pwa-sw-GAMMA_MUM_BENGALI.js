(function() {
	...
	var hostName = "https://bengali-mum-gamma.pratilipi.com";
	var apiPrefix = "https://bengali-mum-gamma.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_MUM_BENGALI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_MUM_BENGALI.json" ) === -1
