(function() {
	...
	var hostName = "https://gr-malayalam.ptlp.co";
	var apiPrefix = "https://gr-malayalam.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_GR_MALAYALAM.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_GR_MALAYALAM.json" ) === -1
