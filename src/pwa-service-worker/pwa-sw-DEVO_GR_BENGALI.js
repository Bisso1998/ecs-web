(function() {
	...
	var hostName = "https://gr-bengali.ptlp.co";
	var apiPrefix = "https://gr-bengali.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_GR_BENGALI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_GR_BENGALI.json" ) === -1
