(function() {
	...
	var hostName = "https://malayalam-devo-gr.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_MALAYALAM_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_MALAYALAM_GR.json" ) === -1
