(function() {
	...
	var hostName = "https://hindi-gamma-gr.pratilipi.com";
	var apiPrefix = "https://hindi-gamma-gr.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-GAMMA_HINDI_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-GAMMA_HINDI_GR.json" ) === -1
