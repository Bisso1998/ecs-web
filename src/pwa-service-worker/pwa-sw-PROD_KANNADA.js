(function() {
	...
	var hostName = "https://kannada-prod.pratilipi.com";
	var apiPrefix = "https://kannada-prod.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-PROD_KANNADA.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-PROD_KANNADA.json" ) === -1
