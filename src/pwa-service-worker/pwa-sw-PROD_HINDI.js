(function() {
	...
	var hostName = "https://hindi-prod.pratilipi.com";
	var apiPrefix = "https://hindi-prod.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-PROD_HINDI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-PROD_HINDI.json" ) === -1
