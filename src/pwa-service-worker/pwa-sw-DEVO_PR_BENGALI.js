(function() {
	...
	var hostName = "https://pr-bengali.ptlp.co";
	var apiPrefix = "https://pr-bengali.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_PR_BENGALI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_PR_BENGALI.json" ) === -1
