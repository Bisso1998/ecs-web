(function() {
	...
	var hostName = "https://marathi-prod.pratilipi.com";
	var apiPrefix = "https://marathi-prod.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-PROD_MARATHI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-PROD_MARATHI.json" ) === -1
