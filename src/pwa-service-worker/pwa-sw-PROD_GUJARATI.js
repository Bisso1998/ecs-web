(function() {
	...
	var hostName = "https://gujarati-prod.pratilipi.com";
	var apiPrefix = "https://gujarati-prod.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-PROD_GUJARATI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-PROD_GUJARATI.json" ) === -1
