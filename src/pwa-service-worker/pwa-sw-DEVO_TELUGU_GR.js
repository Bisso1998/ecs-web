(function() {
	...
	var hostName = "https://telugu-devo-gr.ptlp.co";
	var apiPrefix = "https://telugu-devo-gr.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_TELUGU_GR.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_TELUGU_GR.json" ) === -1
