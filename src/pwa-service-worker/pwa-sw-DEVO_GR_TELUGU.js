(function() {
	...
	var hostName = "https://gr-telugu.ptlp.co";
	var apiPrefix = "https://gr-telugu.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_GR_TELUGU.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_GR_TELUGU.json" ) === -1
