(function() {
	...
	var hostName = "https://pr-gujarati.ptlp.co";
	var apiPrefix = "https://pr-gujarati.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_PR_GUJARATI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_PR_GUJARATI.json" ) === -1
