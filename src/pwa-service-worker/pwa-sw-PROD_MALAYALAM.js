(function() {
	...
	var hostName = "https://malayalam-prod.pratilipi.com";
	var apiPrefix = "https://malayalam-prod.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-PROD_MALAYALAM.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-PROD_MALAYALAM.json" ) === -1
