(function() {
	...
	var hostName = "https://tamil-prod.pratilipi.com";
	var apiPrefix = "https://tamil-prod.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-PROD_TAMIL.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-PROD_TAMIL.json" ) === -1
