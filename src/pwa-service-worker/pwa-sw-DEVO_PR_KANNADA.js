(function() {
	...
	var hostName = "https://pr-kannada.ptlp.co";
	var apiPrefix = "https://pr-kannada.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_PR_KANNADA.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_PR_KANNADA.json" ) === -1
