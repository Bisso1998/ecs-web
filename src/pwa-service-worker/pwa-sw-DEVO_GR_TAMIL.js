(function() {
	...
	var hostName = "https://gr-tamil.ptlp.co";
	var apiPrefix = "https://gr-tamil.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_GR_TAMIL.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_GR_TAMIL.json" ) === -1
