(function() {
	...
	var hostName = "https://www-prod.pratilipi.com";
	var apiPrefix = "https://www-prod.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-PROD_ALL_LANGUAGE.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-PROD_ALL_LANGUAGE.json" ) === -1
