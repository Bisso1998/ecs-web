(function() {
	...
	var hostName = "https://telugu-prod.pratilipi.com";
	var apiPrefix = "https://telugu-prod.pratilipi.com";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-PROD_TELUGU.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-PROD_TELUGU.json" ) === -1
