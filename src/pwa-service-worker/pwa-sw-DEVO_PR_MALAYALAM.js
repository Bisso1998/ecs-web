(function() {
	...
	var hostName = "https://pr-malayalam.ptlp.co";
	var apiPrefix = "https://pr-malayalam.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_PR_MALAYALAM.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_PR_MALAYALAM.json" ) === -1
