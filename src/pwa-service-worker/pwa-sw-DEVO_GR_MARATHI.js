(function() {
	...
	var hostName = "https://gr-marathi.ptlp.co";
	var apiPrefix = "https://gr-marathi.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_GR_MARATHI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_GR_MARATHI.json" ) === -1
