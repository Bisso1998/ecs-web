(function() {
	...
	var hostName = "https://gr-gujarati.ptlp.co";
	var apiPrefix = "https://gr-gujarati.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_GR_GUJARATI.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_GR_GUJARATI.json" ) === -1
