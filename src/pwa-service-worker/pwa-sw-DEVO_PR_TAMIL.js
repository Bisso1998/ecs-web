(function() {
	...
	var hostName = "https://pr-tamil.ptlp.co";
	var apiPrefix = "https://pr-tamil.ptlp.co";
...
//				}
	...
	self.addEventListener( 'fetch', function(event) {
		...
		if( url.indexOf( hostName ) > -1
			...
			&& url.indexOf( hostName + "/pwa-sw-DEVO_PR_TAMIL.js" ) === -1
			...
			&& url.indexOf( hostName + "/pwa-manifest-DEVO_PR_TAMIL.json" ) === -1
