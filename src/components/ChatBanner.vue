<template>
    <span>
        <div class="chat-banner">
            ...
            <h4>Message this author?</h4>
            <p>
                <i class="material-icons">chat</i>
                <span>__("chat_guest_msg")</span>
            </p>
            <button class="check_now" type="button" name="button" @click="scrollToMessage">Check Now</button>
        </div>
    </span>
</template>
    ...
    methods: {
        ...
        scrollToMessage() {
            $('html, body').animate({
                ...
                $('.about-author').addClass('fade-it');
                setTimeout(function () { 
                    $('.about-author').removeClass('fade-it');
                }, 1000);
