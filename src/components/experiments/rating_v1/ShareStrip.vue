...
export default {
    ...
    methods: {
        ...
        triggerFbEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKFB_BOOKM_BOOK`, 'WGEN001', {
        ...
        triggerGpEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKGP_BOOKM_BOOK`, 'WGEN001', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,
        ...
        triggerTwEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKTW_BOOKM_BOOK`, 'WGEN001', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,
        ...
        triggerWaEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKWA_BOOKM_BOOK`, 'WGEN001', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,
