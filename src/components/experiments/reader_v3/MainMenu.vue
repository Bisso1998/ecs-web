...
export default {
    ...
    methods: {
        triggerHomeEvent() {
            ...
            this.triggerAnanlyticsEvent('GOHOME_HEADER_GLOBAL', 'WGEN007', {
        ...
        triggerLoginEvent() {
            const SCREEN_NAME = this.getAnalyticsPageSource(this.$route.meta.store);
            this.triggerAnanlyticsEvent('GOLOGIN_HEADER_GLOBAL', 'WGEN007', {
                'USER_ID': this.getUserDetails.userId,
                SCREEN_NAME
            });
        ...
        triggerProfileEvent() {
            const SCREEN_NAME = this.getAnalyticsPageSource(this.$route.meta.store);
            this.triggerAnanlyticsEvent('GOMYPROFILE_HEADER_GLOBAL', 'WGEN007', {
                'USER_ID': this.getUserDetails.userId,
                SCREEN_NAME
            });
        ...
        triggerCreateEvent() {
            const SCREEN_NAME = this.getAnalyticsPageSource(this.$route.meta.store);
            this.triggerAnanlyticsEvent('GOCREATE_HEADER_GLOBAL', 'WGEN007', {
                'USER_ID': this.getUserDetails.userId,
                SCREEN_NAME
            });
        },
        triggerDiscoverEvent() {
            const SCREEN_NAME = this.getAnalyticsPageSource(this.$route.meta.store);
            this.triggerAnanlyticsEvent('GODISCOVER_HEADER_GLOBAL', 'WGEN007', {
                'USER_ID': this.getUserDetails.userId,
                SCREEN_NAME
            });
        },
