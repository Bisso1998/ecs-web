...
export default {
    ...
    methods: {
        ...
        changeRating(e) {
            ...
            this.triggerAnanlyticsEvent(`${action}_${this.screenLocation}_${this.screenName}`, 'WGEN008', {
        ...
        'inViewport.now': function(visible) {
            if (visible) {
                ...
                if (this.screenLocation === 'BOOKEND' && this.screenName === 'READER') {
                    this.triggerAnanlyticsEvent(`LANDED_${this.screenLocation}_${this.screenName}`, 'WGEN008', {
                        'USER_ID': this.getUserDetails.userId
                    });    
                } else {
                    this.triggerAnanlyticsEvent(`VIEWED_${this.screenLocation}_${this.screenName}`, 'WGEN008', {
                        'USER_ID': this.getUserDetails.userId
                    });
                }
