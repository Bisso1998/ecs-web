...
export default {
    ...
    methods: {
        ...
        triggerFbEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKFB_BOOKM_BOOK`, 'WGEN002', {
        ...
        triggerGpEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKGP_BOOKM_BOOK`, 'WGEN002', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,
        ...
        triggerTwEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKTW_BOOKM_BOOK`, 'WGEN002', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,
        ...
        triggerWaEndShareEvent() {
            ...
            this.triggerAnanlyticsEvent(`SHAREBOOKWA_BOOKM_BOOK`, 'WGEN002', {
                ...pratilipiAnalyticsData,
                'USER_ID': this.getUserDetails.userId,
