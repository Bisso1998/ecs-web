...
<script>
import ReadLayout from '@/layout/experiments/reader_v4/Reader-layout.vue';
...
import Reviews from '@/components/experiments/reader_v4/Reviews.vue';
    ...
    watch: {
        ...
        'getPratilipiLoadingState'(status) {
            if (status === 'LOADING_SUCCESS') {
                const pratilipiAnalyticsData = this.getPratilipiAnalyticsData(this.getPratilipiData);
                this.triggerAnanlyticsEvent('LANDED_READERM_READER', 'WGEN008', {
                    ...pratilipiAnalyticsData,
                    'USER_ID': this.getUserDetails.userId
                });
            }
