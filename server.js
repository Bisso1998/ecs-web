...
var Website = defineEnum({
	...
	GAMMA_ALL_LANGUAGE_GR:	{ hostName: "www-gamma-gr.pratilipi.com:8080",          mobileHostName: "m-gamma-gr.pratilipi.com:8080",  displayLanguage: Language.ENGLISH,	filterLanguage: null },
	GAMMA_HINDI_GR:			{ hostName: "hindi-gamma-gr.pratilipi.com:8080",        mobileHostName: "hi-gamma-gr.pratilipi.com:8080", displayLanguage: Language.HINDI,		filterLanguage: Language.HINDI },
	GAMMA_GUJARATI_GR:		{ hostName: "gujarati-gamma-gr.pratilipi.com:8080",     mobileHostName: "gu-gamma-gr.pratilipi.com:8080", displayLanguage: Language.GUJARATI,	filterLanguage: Language.GUJARATI },
	GAMMA_TAMIL_GR:			{ hostName: "tamil-gamma-gr.pratilipi.com:8080",        mobileHostName: "ta-gamma-gr.pratilipi.com:8080", displayLanguage: Language.TAMIL,		filterLanguage: Language.TAMIL },
	GAMMA_MARATHI_GR:		{ hostName: "marathi-gamma-gr.pratilipi.com:8080",      mobileHostName: "mr-gamma-gr.pratilipi.com:8080", displayLanguage: Language.MARATHI,	filterLanguage: Language.MARATHI },
	GAMMA_MALAYALAM_GR:		{ hostName: "malayalam-gamma-gr.pratilipi.com:8080",    mobileHostName: "ml-gamma-gr.pratilipi.com:8080", displayLanguage: Language.MALAYALAM,	filterLanguage: Language.MALAYALAM },
	GAMMA_BENGALI_GR:		{ hostName: "bengali-gamma-gr.pratilipi.com:8080",      mobileHostName: "bn-gamma-gr.pratilipi.com:8080", displayLanguage: Language.BENGALI,	filterLanguage: Language.BENGALI },
	GAMMA_KANNADA_GR:		{ hostName: "kannada-gamma-gr.pratilipi.com:8080",      mobileHostName: "kn-gamma-gr.pratilipi.com:8080", displayLanguage: Language.KANNADA,	filterLanguage: Language.KANNADA },
	GAMMA_TELUGU_GR:		    { hostName: "telugu-gamma-gr.pratilipi.com:8080",       mobileHostName: "te-gamma-gr.pratilipi.com:8080", displayLanguage: Language.TELUGU,	filterLanguage: Language.TELUGU },
	...
	DEVO_ALL_LANGUAGE_GR:{ hostName: "www-devo-gr.ptlp.co:8080",       mobileHostName: "m-devo-gr.ptlp.co:8080", displayLanguage: Language.ENGLISH,		filterLanguage: null },
	DEVO_HINDI_GR:       { hostName: "hindi-devo-gr.ptlp.co:8080",     mobileHostName: "hi-devo-gr.ptlp.co:8080", displayLanguage: Language.HINDI,		filterLanguage: Language.HINDI },
	DEVO_GUJARATI_GR:    { hostName: "gujarati-devo-gr.ptlp.co:8080",  mobileHostName: "gu-devo-gr.ptlp.co:8080", displayLanguage: Language.GUJARATI,	filterLanguage: Language.GUJARATI },
	DEVO_TAMIL_GR:       { hostName: "tamil-devo-gr.ptlp.co:8080",     mobileHostName: "ta-devo-gr.ptlp.co:8080", displayLanguage: Language.TAMIL,		filterLanguage: Language.TAMIL },
	DEVO_MARATHI_GR:     { hostName: "marathi-devo-gr.ptlp.co:8080",   mobileHostName: "mr-devo-gr.ptlp.co:8080", displayLanguage: Language.MARATHI,	filterLanguage: Language.MARATHI },
	DEVO_MALAYALAM_GR:   { hostName: "malayalam-devo-gr.ptlp.co:8080", mobileHostName: "ml-devo-gr.ptlp.co:8080", displayLanguage: Language.MALAYALAM,	filterLanguage: Language.MALAYALAM },
	DEVO_BENGALI_GR:     { hostName: "bengali-devo-gr.ptlp.co:8080",   mobileHostName: "bn-devo-gr.ptlp.co:8080", displayLanguage: Language.BENGALI,	filterLanguage: Language.BENGALI },
	DEVO_TELUGU_GR:      { hostName: "telugu-devo-gr.ptlp.co:8080",    mobileHostName: "te-devo-gr.ptlp.co:8080", displayLanguage: Language.TELUGU,	filterLanguage: Language.TELUGU },
	DEVO_KANNADA_GR:     { hostName: "kannada-devo-gr.ptlp.co:8080",   mobileHostName: "kn-devo-gr.ptlp.co:8080", displayLanguage: Language.KANNADA,	filterLanguage: Language.KANNADA },
